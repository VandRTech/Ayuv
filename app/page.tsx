...
const fadeInUp: Variants = {
    hidden: { opacity: 0, y: 20 }, // Increased y slightly for more noticeable effect
    visible: { opacity: 1, y: 0, transition: { duration: 0.6, ease: "easeOut" } },
}

// NEW: Variant for sliding in from the left
...
// Removed cardHoverEffect as it's applied inline now for glow
        ...
        <div className="flex min-h-screen flex-col bg-gray-900 text-gray-300">
            ...
            >
                <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    {/* // UPDATE: Increased header height */}
            ...
            <main>
                ...
                <section className="relative w-full overflow-hidden bg-gray-900 py-24 sm:py-32 lg:py-40">
                    ...
                    >
                        <Image
                            ...
                            layout="fill"
                            objectFit="cover"
                            className="opacity-15 sm:opacity-20 mix-blend-soft-light"
                            priority
                        />
                         {/* UPDATE: Animated Overlay */}
                         <motion.div
                            className="absolute inset-0 bg-gradient-to-b from-gray-900/30 to-gray-900"
                            initial={{ opacity: 0.7 }}
                            animate={{ opacity: 1 }}
                            transition={{ duration: 4, repeat: Infinity, repeatType: 'reverse', ease: 'easeInOut' }} // Slow pulse
                         />
                    </motion.div>
                ...
                <motion.section
                    id="features"
                    className="w-full bg-gray-900 py-16 lg:py-24"
                    initial="hidden"
                    whileInView="visible"
                        ...
                        <motion.div
                         ...
                         >
                            {[
                                ...
                                const colors = {
                                    blue: { bg: 'bg-blue-900', text: 'text-blue-300', glow: 'rgba(96, 165, 250, 0.5)' }, // blue-400 glow
                                    green: { bg: 'bg-green-900', text: 'text-green-300', glow: 'rgba(52, 211, 153, 0.5)' }, // green-400 glow
                                    purple: { bg: 'bg-indigo-900', text: 'text-indigo-300', glow: 'rgba(129, 140, 248, 0.5)' }, // indigo-400 glow
                                    orange: { bg: 'bg-teal-900', text: 'text-teal-300', glow: 'rgba(45, 212, 191, 0.5)' }, // teal-400 glow
                                };
                                const colorClass = colors[feature.color as keyof typeof colors];
                                return (
                                     // UPDATE: Using fadeInFromLeft for cards
                                    <motion.div key={index} variants={fadeInFromLeft}>
                                         {/* UPDATE: Added glow on hover */}
                                        <motion.div
                                            whileHover={{ scale: 1.03, boxShadow: `0 0 25px ${colorClass.glow}` }}
                                            transition={{ duration: 0.3 }}
                                            className="h-full p-px rounded-lg" // Added padding for glow space if needed
                                         >
                ...
                <motion.section
                    id="how-it-works"
                    className="w-full bg-gray-800 py-16 lg:py-24"
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.2 }}
                    variants={staggerContainer}
                            ...
                            {[
                                ...
                                return (
                                    <motion.div key={index} variants={fadeInUp} className="relative">
                                         {/* UPDATE: Adjusted connecting line positioning */}
                                        {index < 3 && (
                                            <div
                                                aria-hidden="true"
                                                className="absolute left-1/2 top-7 hidden h-0.5 w-[calc(100%+2rem)] translate-x-4 bg-blue-800 lg:block -z-0" // Starts center, spans width+gap, shifts right by half gap(1rem for gap-8)
                                            />
                                        )}
                                        <div className="flex flex-col items-center text-center">
                 ...
                 {/* Sections below keep the previous subtle animations for balance */}
                                ...
                                {[
                                    ...
                                    <CarouselItem key={index} className="pl-4 md:basis-1/2 lg:basis-1/3">
                                        <motion.div
                                            ...
                                            whileHover={{ scale: 1.02 }} // Simpler hover for testimonial cards
                                        >
                ...
                <motion.section
                    id="early-access"
                    className="w-full bg-gray-800 py-16 lg:py-20"
                    initial="hidden"
                    whileInView="visible"
                ...
                {/* CTA Section */}
                <motion.section
                    className="w-full bg-blue-700 py-16 lg:py-20 text-white"
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.3 }}
                    variants={staggerContainer}
